package  org.tensorflow.lite.examples.detection.expansionpanel.viewgroup;
...
//import  org.tensorflow.lite.examples.detection.expansionpanel.R;
...
public class ExpansionsViewGroupRelativeLayout extends LinearLayout {
    ...
    private void init(@NonNull Context context, @Nullable AttributeSet attrs) {
        if (attrs != null) {
            final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.ExpansionsViewGroupRelativeLayout);//R.styleable.ExpansionsViewGroupRelativeLayout);
            if (a != null) {
