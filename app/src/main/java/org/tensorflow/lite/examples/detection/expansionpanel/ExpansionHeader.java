package  org.tensorflow.lite.examples.detection.expansionpanel;
...
public class ExpansionHeader extends FrameLayout {
    ...
    private void init(@NonNull Context context, @Nullable AttributeSet attrs) {
        if (attrs != null) {
            final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.ExpansionHeader);//ExPansionHeader);//ExpansionHeader);
            if (a != null) {
